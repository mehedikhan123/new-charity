        ...
        <div class="row gy-4 d-flex justify-content-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="col-md-6">
                ...
                <div class="d-flex mt-4 mb-2 align-items-center justify-content-center">
                    <img src="{{ asset('storage/uploads/photo/' . $global_setting_data->map_1_country_photo) }}" alt="" class="img-fluid" style="object-fit: cover; width: 50%; height: 25vh;">
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="d-flex mt-4 mb-2 align-items-center justify-content-center">
                    <img src="{{ asset('storage/uploads/photo/' . $global_setting_data->map_2_country_photo) }}" alt="" class="img-fluid" style="object-fit: cover; width: 50%; height: 25vh;">
                </div>
