...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        return view('admin.dashboard', compact('total_causes', 'total_orphans', 'total_appeals', 'total_programs', 'total_testimonials', 'total_users', 'total_executives', 'total_volunteers', 'total_posts', 'total_photos', 'total_videos'));
    }
    ...
    public function edit_profile_submit(Request $request)
    {
        ...
        if($request->photo != null) {
            ...
            if(Auth::guard('admin')->user()->photo != null) {
                unlink(public_path('storage/uploads/photo/'.Auth::guard('admin')->user()->photo));
            }
